...
) : KotlinScriptDefinition(KotlinScriptDefinition::class.java.classLoader.loadClass(scriptCompilerConfiguration[ScriptingEnvironmentProperties.baseClass].typeName).kotlin) {
